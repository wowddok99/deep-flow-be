...
/**
 * 통계 대시보드 검증용 테스트 데이터 시더 (local 프로파일 전용).
 *
...
public class TestDataSeeder implements CommandLineRunner {
    ...
    /**
     * 세션 + DailyFocusStats를 함께 적재한다.
     * DailyFocusStats는 자정 경계 분할 로직(DailyFocusStatsService.upsertStats)을 시뮬레이션한다.
     */
